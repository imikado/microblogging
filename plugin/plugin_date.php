...
class plugin_date{
	...
	*/
	...
	/**
	* @access public
	* @return bool  retourne true/false selon que la journee soit ferie (noel,jour de l'an,jeudi de l'ascension, dimanche de paque,samedi,dimanche,lundi de paques, 1er mai, 8 mai)
	*/
